...
print(xtable(BSTcmYArank_4[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank_lw/BSTcm_ankYA4.tex")
...
print(xtable(BSTcmMArank_4[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank_lw/BSTcm_ankMA4.tex")
...
print(xtable(BSTcmOArank_4[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank_lw/BSTcm_ankOA4.tex")
