...
#Take data from just ankle 
train2_nomiss_ank <- train2_nomiss_all[,c(1:24,97:101)]
test2_nomiss_ank <- test2_nomiss_all[,c(1:24,97:101)]
...
print(xtable(BSTcmYArank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcmankYA2.tex")
...
print(xtable(BSTcmMArank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcmankMA2.tex")
...
print(xtable(BSTcmOArank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcmankOA2.tex")
