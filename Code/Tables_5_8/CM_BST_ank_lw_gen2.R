...
#Take data for just ankle and lw 
train_nomiss_lw_ank <- train2_nomiss_all[,c(1:24,49:72,97:101)]
test_nomiss_lw_ank <- test2_nomiss_all[,c(1:24,49:72,97:101)]
...
print(xtable(BSTcmrank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcm_anklw2.tex")
...
print(xtable(BSTcmFrank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcm_anklwF2.tex")
...
print(xtable(BSTcmMrank_2[[1]], digits=4,type = "latex"), file = "C:/Users/Drew/Box Sync/Drew Lazar/Rcodes/MedianDiff/ConfusionMatrices/BoostCM_ank/BSTcm_anklwM2.tex")
